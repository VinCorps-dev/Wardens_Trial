...
class PhysicsEntity:
    ...
    def _handle_x_collision(self, Tilemap, movement):
        ...
        for rect in Tilemap.physics_rects_around(self.pos):
            entity_rect = self.rect()  # refresh every iteration so pos stays in sync
    ...
    def _handle_platform_collision(self, Tilemap):
        ...
        tile_size = Tilemap.tile_size  # single source of truth
        ...
        for tile in Tilemap.tiles_around(self.pos):
            ...
            entity_rect = self.rect()  # fresh rect per tile check
